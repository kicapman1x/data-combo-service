...
def bootstrap():
    ...
    global payload_dir, tmp_dir, ca_cert, n_sampled, logdir, loglvl, kafka_url, cert_file, key_file, PRODUCE_TOPIC_NAME, count, kafka_producer_conn
    ...
    n_sampled= int(os.environ.get("sampled_flights_no", "10")),
